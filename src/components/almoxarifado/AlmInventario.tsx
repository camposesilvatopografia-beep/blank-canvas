    ...
    <div className="space-y-4">
      ...
      <div className="border rounded-lg overflow-auto">
        <Table>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              <TableRow><TableCell colSpan={visibleCount} className="text-center py-12 text-muted-foreground px-6">Nenhum material encontrado no inventário com os filtros atuais.</TableCell></TableRow>
            ) : filtered.map((m, i) => {
