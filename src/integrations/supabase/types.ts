...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      carga: {
        Row: {
          Add_Descarga: string | null
          Data: string | null
          Descricao_Cb: string | null
          Descricao_Eq: string | null
          Empresa_Cb: string | null
          Empresa_Eq: string | null
          Estaca: string | null
          Hora_Carga: string | null
          ID: string | null
          Local_da_Obra: string | null
          Local_da_Obra_1: string | null
          Material: string | null
          Motorista: string | null
          N_Viagens: number | null
          Observacao: string | null
          Operador: string | null
          Potencia: string | null
          Prefixo_Cb: string | null
          Prefixo_Eq: string | null
          Usuario: string | null
          Volume: string | null
