...
export default function FormCaminhoesAreiaExpress() {
  ...
  const openEdit = (item: CaminhaoRow) => {
    setForm({ placa: item.placa, descricao: 'Caminhão Basculante', empresa: 'Areia Express', motorista: item.motorista, pesoVazio: item.pesoVazio.replace(/\D/g, '') });
    setIsNew(false);
    setEditItem(item);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white p-4 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight">Caminhões Areia Express</h1>
